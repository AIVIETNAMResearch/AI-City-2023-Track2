...
fea_dic = np.load("./front_color.npy",allow_pickle=True).item()
...
with open("./front_test_color_predict_no_avg_0.5.json") as f:
# with open("./front_test_color_predict_one_hot_0.5.json") as f:
...
np.save("./front_color_ensemble.npy",color_new)