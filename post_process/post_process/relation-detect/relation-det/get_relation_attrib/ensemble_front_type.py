...
fea_dic = np.load("./front_type.npy",allow_pickle=True).item()
...
with open("./front_test_vehicle_predict_no_avg_0.5.json") as f:
# with open("./front_test_vehicle_predict_one_hot_0.5.json") as f:
...
np.save("./front_type_ensemble.npy",color_new)