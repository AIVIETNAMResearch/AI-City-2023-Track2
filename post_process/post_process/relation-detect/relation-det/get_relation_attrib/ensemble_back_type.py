...
fea_dic = np.load("./back_type.npy",allow_pickle=True).item()
...
with open("./back_test_vehicle_predict_no_avg_0.5.json") as f:
# with open("./back_test_vehicle_predict_one_hot_0.5.json") as f:
...
np.save("./back_type_ensemble.npy",color_new)